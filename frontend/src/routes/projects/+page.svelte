...
<div class=" flex flex-col w-full h-full overflow-x-hidden bg-white p-4">
  <div class="flex flex-row justify-between m-4">
    ...
    <div class="flex flex-row items-center gap-2 m1-auto">
      <button
        on:click={() => {
          showRowsWithZeroHours = !showRowsWithZeroHours;
        }}
      >
      ...
      <button class="text-sm font-semibold text-white bg-red-500 hover:bg-red-600 rounded-lg px-4 py-2"> Delete Project </button>
  ...
  <div class="relative shadow-md sm:rounded-lg">
    ...
    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 table-fixed">
      ...
      <col style="width: 120px;" /> <!-- Project Id -->
      <col style="width: 220px;" /> <!-- Project Name -->
      <col style="width: 120px;" /> <!-- Total Hours -->
      <col style="width: 180px;" /> <!-- Tags -->
